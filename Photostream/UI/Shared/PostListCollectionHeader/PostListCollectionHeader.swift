...
class PostListCollectionHeader: UICollectionReusableView, PostListCollectionHeaderAction {
    ...
    func initSetup() {
        ...
        reportButton.addTarget(self, action: #selector(self.didTapReport), for: .touchUpInside)
        reportButton.setImage(UIImage(named: "threedots"), for: .normal)
    ...
    override func layoutSubviews() {
        ...
        reportButton.frame = avatarImageView.frame
        reportButton.frame.origin.x = self.frame.width - avatarImageView.frame.width - 10
