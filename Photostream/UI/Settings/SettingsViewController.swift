...
class SettingsViewController: UITableViewController, SettingsViewControllerAction {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if itemName == "Import Photos" {
            let googleVC = GoogleDriveViewController(nibName: "GoogleDriveViewController", bundle: nil)
            googleVC.queryContent =  "mimeType='application/vnd.google-apps.folder' and trashed=false"
